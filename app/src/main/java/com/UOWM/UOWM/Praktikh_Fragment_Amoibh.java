...
public class Praktikh_Fragment_Amoibh extends Fragment {
    ProgressBar progress;
    SwipeRefreshLayout mySwipeRefreshLayout;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_praktikh_amoibh, container, false);


        final WebView webView = (WebView) v.findViewById(R.id.praktikhamoibh);
        ...
        String url ="https://ba.uowm.gr/praktiki/amoivi-kai-asfalisi-praktikis-askisis/";
        webView.loadUrl(url);
