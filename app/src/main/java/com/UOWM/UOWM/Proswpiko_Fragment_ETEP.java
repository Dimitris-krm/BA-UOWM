...
public class Proswpiko_Fragment_ETEP extends Fragment {
    ProgressBar progress;
    SwipeRefreshLayout mySwipeRefreshLayout;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_proswpiko_etep, container, false);
        ...
        String url ="https://ba.uowm.gr/prosopiko/etep/";
        webView.loadUrl(url);
