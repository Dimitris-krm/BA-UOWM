...
public class Praktikh_Fragment_Xartia extends Fragment {
    ProgressBar progress;
    SwipeRefreshLayout mySwipeRefreshLayout;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_praktikh_xartia, container, false);

        final WebView webView = (WebView) v.findViewById(R.id.praktikhxartia);
        ...
        String url ="https://ba.uowm.gr/praktiki/chrisima-entypa-praktikis/";
        webView.loadUrl(url);
