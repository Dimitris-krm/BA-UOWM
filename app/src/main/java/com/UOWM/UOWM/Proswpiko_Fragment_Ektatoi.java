...
public class Proswpiko_Fragment_Ektatoi extends Fragment {
    ProgressBar progress;
    SwipeRefreshLayout mySwipeRefreshLayout;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_proswpiko_ektatoi, container, false);
        ...
        String url ="https://ba.uowm.gr/prosopiko/ektaktoi/";
        webView.loadUrl(url);
