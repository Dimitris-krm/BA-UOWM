...
public class Proswpiko_Fragment_Dioikhtiko extends Fragment {
    ProgressBar progress;
    SwipeRefreshLayout mySwipeRefreshLayout;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_proswpiko_dioikhtiko, container, false);
        ...
        String url ="https://ba.uowm.gr/dioikitiko/";
        webView.loadUrl(url);
