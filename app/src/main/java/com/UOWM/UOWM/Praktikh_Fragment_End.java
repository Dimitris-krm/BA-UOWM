...
public class Praktikh_Fragment_End extends Fragment {
    ProgressBar progress;
    SwipeRefreshLayout mySwipeRefreshLayout;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_praktikh_end, container, false);




        final WebView webView = (WebView) v.findViewById(R.id.praktikhend);
        ...
        String url ="https://ba.uowm.gr/praktiki/lixi-praktikis-askisis/";
        webView.loadUrl(url);
