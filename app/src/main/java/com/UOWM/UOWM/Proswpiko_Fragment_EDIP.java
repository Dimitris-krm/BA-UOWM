...
public class    Proswpiko_Fragment_EDIP extends Fragment {
    ProgressBar progress;
    SwipeRefreshLayout mySwipeRefreshLayout;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_proswpiko_edip, container, false);
        ...
        String url ="https://ba.uowm.gr/edip/";
        webView.loadUrl(url);
