...
public class Entupa_Fragment extends Fragment {
    ProgressBar progress;
    SwipeRefreshLayout mySwipeRefreshLayout;

    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_entupa, container, false);

        final WebView webView = (WebView) v.findViewById(R.id.webviewentupa);
        ...
        String url ="https://ba.uowm.gr/chrisima-entypa/";
        webView.loadUrl(url);
    ...
    public void onResume() {
        ...
        ((MainActivity) getActivity())
                .setActionBarTitle("Χρήσιμα Έντυπα");
    }
